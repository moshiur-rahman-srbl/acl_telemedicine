        ...
        <table style="margin:0 auto;padding:0;width:100%;border-collapse:collapse;">
            ...
            <tr>
                <td colspan="4" class="td-title">
                    <strong>{{strtoupper(__('B2B TRANSFER'))}}</strong>
                </td>
            </tr>
            <tr>
                <td class="td-label">
                ...
                <td class="td-value">{{\App\Utils\Date::format(0,$data['transaction_date'])}}</td>
            </tr>
            <tr>
                <td class="td-label">
                    <strong>{{__('SENDER MERCHANT')}}: </strong>
                </td>
                <td class="td-value">{{$data['sender_merchant_name']}}</td>
                <td class="td-label">
                    <strong>{{__('RECEIVER MERCHANT')}}: </strong>
                </td>
                <td class="td-value">{{$data['receiver_merchant_name']}}</td>
            </tr>
            <tr>
                <td class="td-label">
