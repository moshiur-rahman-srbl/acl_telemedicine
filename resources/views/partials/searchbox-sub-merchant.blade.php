    ...
    <div class="row justify-content-left">
        ...
        <div class="col-lg-3 col-md-3 pt-4">
            <div class="input-group-icon input-group-icon-right">
                ...
                <input class="form-control-rounded form-control" value="{{$search['searchkey']}}" type="text" name="searchkey" placeholder="{{__("Search for...")}}">
            </div>
        </div>

        <div class="col-lg-2 col-md-2 pt-4 text-center">
            <button class="btn btn-outline-secondary btn-block btn-std-padding btn-block" type="submit">{{__('Search')}}</button>
        </div>

        <div class="col-lg-2 col-md-2 pt-4 text-right">
            <input type="submit" name="exportSubMerchant" class="btn btn-outline-secondary btn-std-padding btn-block  btn-rounded" value="{{__("Export")}}">
        </div>
    </div>
</form>
