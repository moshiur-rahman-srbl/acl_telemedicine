        ...
        <table style="margin:0 auto;padding:0;width:100%;border-collapse:collapse;">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-value">{{\App\Utils\CommonFunction::getFormatedUserName($data->to_name, auth()->user()->user_category)}}</td>
                </tr>
                <tr>
                    ...
                    <td class="td-label"><strong>{{__('Receiver GSM')}}: </strong></td>
                    <td class="td-value">{{$data->to_gsm_number}}</td>
                </tr>
                <tr>
