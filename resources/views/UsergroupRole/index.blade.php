...
<div class="page-content fade-in-up">
    ...
    <div class="ibox">
        <form action="{{route(Config::get('constants.defines.APP_USERGROUP_ROLE_ASSOCIATION'))}}" method="post">
            @csrf
            <div class="ibox-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box-footer">
                            ...
                            @if(Auth::user()->hasPermissionOnAction( Config::get('constants.defines.APP_USERGROUP_EDIT_ROLE_ASSOCIATION') ) )
...
<script>
    ...
    $(document).on('change', '#company-usergroup', function () {
        ...
        if(selectedValue) {
            $.ajax({
                type: "GET",
                url: '{{url(config('constants.defines.ADMIN_URL_SLUG')."/usergroup-role-association/getassociation/")}}/'+selectedValue,
                dataType: "json",
