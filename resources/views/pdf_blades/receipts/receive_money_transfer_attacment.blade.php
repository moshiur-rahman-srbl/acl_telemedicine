        ...
        <table style="margin:0 auto;padding:0;width:100%;border-collapse:collapse;">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-value">{{\App\Utils\Date::format(null,$data->created_at)}}</td>
                </tr>
                <tr>
                    ...
                    <td class="td-label"><strong>{{__('Sender')}}: </strong></td>
                    <td class="td-value">{{\App\Utils\CommonFunction::getFormatedUserName($data->from_name, auth()->user()->user_category)}}</td>
                </tr>
                <tr>
                    ...
                    <td class="td-label"><strong>{{__('Sender GSM')}}: </strong></td>
                    <td class="td-value">{{$data->from_gsm_number}}</td>
                </tr>
                <tr>
