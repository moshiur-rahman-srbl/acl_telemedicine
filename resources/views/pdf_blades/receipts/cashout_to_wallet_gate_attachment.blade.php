        ...
        <table style="margin:0 auto;padding:0;width:100%;border-collapse:collapse;">
            ...
            <tr>
                <td colspan="4" class="td-title">
                    <strong>{{strtoupper(__('Cashout to Wallet Gate'))}}</strong>
                </td>
            </tr>
            <tr>
                <td class="td-label">
            ...
            <tr>
                ...
                <td class="td-label">
                    <strong>{{__('SENDER MERCHANT ID')}}: </strong>
                </td>
                <td class="td-value">{{$data->sender_merchant_id}}</td>
            </tr>
            <tr>
                <td class="td-label">
                    <strong>{{__('RECEIVER ACCOUNT NO')}}: </strong>
                </td>
                <td class="td-value">{{$data->receiver_account_number}}</td>
                <td class="td-label">
