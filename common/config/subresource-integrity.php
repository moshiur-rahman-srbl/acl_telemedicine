<?php
	...
	if(file_exists(config_path('subresource-hash.php'))){
		require_once(config_path('subresource-hash.php'));
	}
	...
	$config =  [
		...
		*/
		...
		'algorithm' => env('SRI_ALGORITHM', 'sha512'),
