                                ...
                                <div class="ibox-body">
                                    <div class="form-group {{$errors->has('doctor_id') ? 'has-error':''}}">
                                        ...
                                        <select class="form-control" name="doctor_id" id="doctor_id">
                                            ...
                                            @foreach($doctors as $doctor)
                                                <option value="{{ $doctor->id }}" {{ $model->doctor_id == $doctor->id ? 'selected' : '' }}>
                                                    {{ $doctor->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group {{$errors->has('patient_id') ? 'has-error':''}}">
                                        ...
                                        <select class="form-control" name="patient_id" id="patient_id">
                                            ...
                                            @foreach($patients as $patient)
                                                <option
                                                    value="{{ $patient->id }}" {{ $model->patient_id == $patient->id ? 'selected' : '' }}>
                                                    {{ $patient->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group {{$errors->has('diagonosis') ? 'has-error':''}}">
                                        ...
                                        <textarea class="form-control" name="diagonosis" id="diagonosis" disabled rows="4"
                                                  placeholder="{{__('Diagnosis Details')}}">{{ $model->diagnosis }}</textarea>
