...
<tr style="margin: 1px 20px;">
    <td style="padding:10px 10px; text-align: center; background: rgba(244,244,244,1); border-radius: 50px">
        <table style="margin:0 auto;padding:0;width:100%;border-collapse:collapse;">
            <tbody>
                <tr>
                    <td colspan="4" class="td-title"><strong>{{__("MONEY TRANSFER")}}</strong></td>
                </tr>
                <tr>
                    <td class="td-label"><strong>{{__('Transaction ID')}}:</strong></td>
                    <td class="td-value">{{$data->id}}</td>
                ...
                <tr>
                    ...
                    <td class="td-value">{{\App\Utils\CommonFunction::getFormatedUserName($data->user_name, auth()->user()->user_category)}}</td>
                    <td class="td-label"><strong>{{__('Receiver Merchant')}}: </strong></td>
                    <td class="td-value">{{\App\Utils\CommonFunction::getFormatedUserName($data->receiver_merchant_name, auth()->user()->user_category)}}</td>
                </tr>
                <tr>
                    ...
                    <td class="td-label"><strong>{{__('Receiver Merchant ID')}}: </strong></td>
                    <td class="td-value">{{$data->receiver_merchant_id}}</td>
                </tr>
                <tr>
